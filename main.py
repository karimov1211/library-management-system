...
# Load environment variables from .env file (root level)
...
DB_DRIVER   = os.getenv("DB_DRIVER", os.getenv("AZURE_SQL_DRIVER", "{ODBC Driver 18 for SQL Server}"))
...
CONFIG_FILE  = "history/network_config.json"
HISTORY_FILE = "history/route_log.json"
...
# Serve React assets from source
